              ...
              <div className="space-y-4">
                ...
                <div className="bg-primary-container/30 rounded-2xl p-4">
                  ...
                  <ul className="space-y-1.5 text-xs text-on-surface-variant leading-relaxed">
                    <li className="flex gap-2"><span className="shrink-0">1.</span>Entry fee charged only for matches you participate in</li>
                    <li className="flex gap-2"><span className="shrink-0">2.</span>Top rankers win from the pool, bottom rankers lose their entry</li>
                    <li className="flex gap-2"><span className="shrink-0">3.</span>Settle balances at the end once IPL is complete</li>
                  </ul>
                </div>
